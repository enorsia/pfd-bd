      ...
      <div class="container">
        <div class="row mb-3 align-items-center">
          <div class="col-12 col-lg-6 mb-3 mb-lg-0">
            <div class="abs-image text-center">
              <img
                src="assets/images/supplier-selection.jpg"
        ...
        <div class="row mb-3 align-items-center">
          <div class="col-12 col-lg-6 mb-3 mb-lg-0">
            <div class="abs-image text-center">
              <img
                src="assets/images/product-development.webp"
                class="img-fluid rounded"
                alt="" />
            </div>
          </div>
        ...
        <div class="row mb-3 align-items-center flex-direction-reverse">
          <div class="col-12 col-lg-6 mb-3 mb-lg-0">
            <div class="abs-image text-center">
              <img
                src="assets/images/Production-Process.jpg"
                class="img-fluid rounded"
                alt="" />
            </div>
          </div>
        ...
        <div class="row mb-3 align-items-center">
          <div class="col-12 col-lg-6 mb-3 mb-lg-0">
            <div class="abs-image text-center">
              <img
                src="assets/images/clothing-qualilty-control.jpg"
                class="img-fluid rounded"
                alt="" />
            </div>
          </div>
          <div class="col-12 col-lg-6">
            <div class="abs-inner">
              <h3>Quality Control Assurance & Inspection</h3>
              <p>
                At Enorsia PFD, we are committed to maintaining the highest
                standards of quality in every aspect of our operations. Our
                comprehensive quality control processes are designed to
                monitor and evaluate every stage of production, ensuring that
                our products meet or exceed client specifications and industry
                standards. We employ skilled professionals and advanced
                testing methodologies to identify any potential issues early,
                allowing us to implement corrective actions promptly and
                deliver consistently exceptional products.
              </p>
            </div>
          </div>
        </div>
        <div class="row mb-3 align-items-center flex-direction-reverse">
          ...
          <div class="col-12 col-lg-6">
            <div class="abs-inner">
              <h3>Shipment</h3>
              <p>
                At Enorsia PFD, we understand that timely delivery is crucial
                to our clients’ success. Our streamlined shipment processes
                are designed to ensure that products are dispatched
                efficiently and arrive on schedule. We collaborate with
                trusted logistics partners to manage all aspects of shipping,
                from documentation to customs clearance, ensuring compliance
                with international standards. Our commitment to transparent
                communication means our clients are kept informed throughout
                the shipping process, allowing for seamless coordination and
                peace of mind as their orders make their way to their
                destination.
              </p>
            </div>
          </div>
